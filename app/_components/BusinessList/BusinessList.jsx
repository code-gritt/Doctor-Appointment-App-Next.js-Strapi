...
function BusinessList({ businessList, title }) {
  return (
    <div style={{ padding: "90px 120px" }} className="mt-5">
      <h2 style={{ marginBottom: "30px" }} className={styles.herotitle}>
        Popular <span className={styles.herosearch}>Services</span>
      </h2>
      <div
        data-aos="zoom-in-up"
          ...
          ? businessList.map((business, index) => (
              ...
              >
                ...
                >
                  ...
                  <button className={styles.signInVectorImgBtn}>
                    Book Now
                  </button>
                </div>
              </Link>
